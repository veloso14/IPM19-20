...
public class PartilharCom extends Fragment {
    ...
    public void prepareList(){
        Data data = new Data("Item1",R.drawable.perfil_joao);
        mDataList.add(data);
        data = new Data("Item2",R.drawable.perfil_joao);
        mDataList.add(data);
        data = new Data("Item3",R.drawable.perfil_joao);
        mDataList.add(data);
        data = new Data("Item4",R.drawable.perfil_joao);
        mDataList.add(data);
        data = new Data("Item5",R.drawable.perfil_joao);
        mDataList.add(data);
    }
